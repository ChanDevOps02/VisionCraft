...
OUTPUT_DIR = PROJECT_ROOT / "logs" / "latent_comparison_v11_infonce_rerun_full180"
...
def load_text_model() -> ResNetTextCrossAttentionSceneClassifier:
    ...
    if not isinstance(model, ResNetTextCrossAttentionSceneClassifier):
        raise TypeError("InfoNCE rerun checkpoint did not load as ResNetTextCrossAttentionSceneClassifier.")
    return model
